            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div v-if="authStore.user?.role === 'Administrator'" @click="openCreateTeamModal" 
                ...
                <div class="text-center relative z-10">
                  ...
                  <p class="font-bold text-lg text-gray-700 dark:text-gray-200 group-hover:text-[#522B5B] dark:group-hover:text-[#DFB6B2] transition-colors duration-300">Crear Nuevo Equipo</p>
