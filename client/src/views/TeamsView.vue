  ...
  <MainLayout>
    ...
    <main class="flex-1 overflow-y-auto bg-light dark:bg-dark-purple p-6">
      <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <h3 class="text-xl font-bold text-dark-purple dark:text-light mb-4">Miembros del Equipo</h3>
        <p class="text-accent dark:text-gray-400">Aquí se mostrará la lista de equipos y sus miembros...</p>
      </div>
    </main>
  </MainLayout>
</template>
