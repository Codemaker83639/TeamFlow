            ...
            <template #item="{ element: task }">
                ...
                >
                  ...
                  <div class="flex justify-between items-center">
                    ...
                    >
                      <svg class="w-3.5 h-3.5 transition-transform duration-200 group-hover/comment:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                      <svg class="w-3.5 h-3.5 transition-transform duration-200 group-hover/view:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
